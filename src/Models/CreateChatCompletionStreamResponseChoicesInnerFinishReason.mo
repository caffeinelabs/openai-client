...
module {
    public type CreateChatCompletionStreamResponseChoicesInnerFinishReason = {
        #stop;
        #length;
        #tool_calls;
        #content_filter;
    ...
    public module JSON {
        public func toCandidValue(value : CreateChatCompletionStreamResponseChoicesInnerFinishReason) : Candid.Candid =
            switch (value) {
                case (#stop) #Text("stop");
        ...
        public func fromCandidValue(candid : Candid.Candid) : ?CreateChatCompletionStreamResponseChoicesInnerFinishReason =
            switch (candid) {
                case (#Text("stop")) ?#stop;
        ...
        public func toText(value : CreateChatCompletionStreamResponseChoicesInnerFinishReason) : Text =
            switch (value) {
                case (#stop) "stop";
                case (#length) "length";
