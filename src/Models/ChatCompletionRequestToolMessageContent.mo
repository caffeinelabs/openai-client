...
module {
    ...
    public module JSON {
        ...
        public func toText(value : ChatCompletionRequestToolMessageContent) : Text =
            switch (value) {
        ...
        // Named "JSON" to avoid shadowing the outer ChatCompletionRequestToolMessageContent type
        public type JSON = {
            #one_of_0 : Text;
            #ChatCompletionRequestMessageContentPartText : [ChatCompletionRequestMessageContentPartText];
        };
        ...
        public func toJSON(value : ChatCompletionRequestToolMessageContent) : JSON =
            switch (value) {
        ...
        public func fromJSON(json : JSON) : ?ChatCompletionRequestToolMessageContent =
            switch (json) {
                case (#one_of_0(v)) ?#one_of_0(v);
                case (#ChatCompletionRequestMessageContentPartText(v)) ?#ChatCompletionRequestMessageContentPartText(v);
            };
        ...
        public func validate(_value : ChatCompletionRequestToolMessageContent) : ?Text = null;
    }
}
